...
// ============================================
const APP_VERSION = '2.7.0'; // Bump to force cache refresh on all devices
...
const CORE_ASSETS = [
  ...
  './js/pdf-processor.js?v=2.7.0',
  './js/sync-manager.js?v=2.7.0',
  './js/admin-manager.js?v=2.7.0',
  './manifest.json',
  './assets/logo_lab_chino_PNG.png?v=2.7.0',
  './config.json'
];
