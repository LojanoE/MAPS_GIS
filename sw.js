...
// ============================================
const APP_VERSION = '2.9.8'; // Bump to force cache refresh on all devices
...
const CORE_ASSETS = [
  './',
  './index.html',
  './css/styles.css?v=2.9.8',
  './js/leaflet-rotate.js?v=2.9.8',
  './js/leaflet-rotate-patches.js?v=2.9.8',
  './js/app.js?v=2.9.8',
  './js/storage.js?v=2.9.8',
  './js/pdf-processor.js?v=2.9.8',
  './js/sync-manager.js?v=2.9.8',
  './js/admin-manager.js?v=2.9.8',
  './manifest.json',
  './assets/logo_lab_chino_PNG.png?v=2.9.8',
  './config.json'
];
